...
import { ImpressaoComponent } from './components/orcamentos/impressao/impressao.component';
...
export const routes: Routes = [
    ...
    {path: 'orcamentos/impressao',  component: ImpressaoComponent,      canActivate: [authGuard]},
